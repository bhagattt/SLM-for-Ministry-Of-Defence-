...
CORPUS_FILES = [
    ...
    "synthetic_mod_corpus.txt",
    "synthetic_mod_corpus_large.txt",
    "synthetic_mod_faq.txt",
...
MERGES_PATH     = "tokenizer_merges.txt"
...
FEEDFORWARD_DIM  = 1024   # Inner dimension of the FFN (4 × embedding_dim)
