# MoD-SLM (Small Language Model) - Complete Guide

## 1. Project Introduction
This project is building a **Small Language Model (SLM)** from the ground up using pure **PyTorch**. It is designed specifically for the **Indian Ministry of Defence (MoD)** and optimized for low-resource environments.
...
### *Generated for the Indian Ministry of Defence SLM Project*
